...
const ListItem = () => {
  ...
  const handleImageChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      setSelectedProduct({ ...selectedProduct, imageUrl }); // Update selected product state
    }
  };
                        ...
                        <DialogContent className="fixed h-[600px] w-[70vw] p-6 bg-white rounded-lg shadow-lg">
                          ...
                          >
                            ...
                            <DialogClose asChild>
                              <Button
                                type="submit"
                                className="bg-[#f0d786] text-white w-min hover:bg-[#f8e4a6] transition-all"
                              >
                                Save Changes
                              </Button>
                            </DialogClose>
                  ...
                  <Button
                    ...
                    className={`${
                      currentPage === pageNumber
                        ? "bg-[#f0d786] text-white hover:bg-[#f0d786]"
                        : ""
                    }`}
                  >
                    {pageNumber}
